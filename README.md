...
### 2024.04.22更新内容
1. 更新自留地与首页内容。
2. 新增囚徒健身页面（网络上尚无可以无广告读取的网页，所以需要新建一个）。
### 2024.04.25更新内容
1. 更新自留地内容。
2. 优化囚徒健身页面按钮，使按钮居中并有些许间隔。
### 2024.05.24更新内容
1. 自留地内容新增网易云外链播放“好听的十大钢琴曲”；
2. 吐槽下网易云音乐。显示外链代码填入网页无法显示，问了智普清言也不能直接修改，只分析了大概原因，后来自己发现可能是外链里链接没加htttps前缀，可能默认调用本地资源失败了，加上就正常了；我本来加的是古典钢琴曲100首的歌单，可以外链只能显示10首，后来查了下，因为外链没登录所以只能显示这么多，无解，所以就换了个10首的歌单省得糟心。
### 2024.05.28更新内容1. 更新自留地内容，删除了一些不用的网站（以后要持续更新，不用或可替代性强的删除掉），增加了一些有趣的网站。2. 自留地内容新增sao.fm电台外链。（有点不稳定，后面再找替代品，目前它最佳）
### 2024.06.28更新内容
1. 更新主页内容。删除了最后一栏用不上的内容；删除了网址导航文字底部的划线，更美观；将右侧滚轮条设置为自动，一般情况下就不会显示了；注释掉了之前的下雪花动态背景暂不启用，启用新的随机彩色气泡上升动态背景。
2. 自留地本来也想去掉导航文字底部划线，但试了下不太好看就没动。
3. 本次的动态背景是用智普清言的GLM-4，第二次提问就达到了效果；GLM-3多次提问都差点意思，效果还不好；看来以后需要有点创造性的问题还是直接问GLM-4。
### 2024.07.18更新内容
1. 调整了部分内容顺序，增加了一些注释，删除了一些冗余注释。
### 2024.10.10更新内容
1. 删除了部分失效外链。（含违规内容的网站还是要注意些，几个月不见已经挂了好几个了。）
### 2024.10.24更新内容
1. 将自留地和囚徒健身页面写成相对路径，方便离线访问。
2. 增加了语音转文字网页，方便以后试用。
3. 修改了网易云音乐参数，不要自动播放。
### 2024.12.06更新内容
1. 更新主页和自留地网址，删除过期或失效网址。
2. 新增部分注释，方便阅读和修改。
3. 主页新增下拉菜单内容，方便新增备用网址。